...
object ConeFakePureImplementationsProvider {
    fun getPurelyImplementedInterface(classFqName: ClassId): ClassId? = pureImplementations[classFqName]

    private val pureImplementations = mutableMapOf<ClassId, ClassId>()
